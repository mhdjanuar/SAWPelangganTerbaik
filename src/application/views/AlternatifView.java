...
import application.daoimpl.PelangganDaoImpl;
...
public class AlternatifView extends javax.swing.JPanel {
    ...
    public final PelangganDao pelangganDao;
    ...
    public AlternatifView() {
      ...
      List<PelangganModel> pelangganList = pelangganDao.findAll();
      pelangganComboBox.addItem(new ComboBoxItem("Pilih pelanggan", -1));
      for (PelangganModel pelanggan : pelangganList) {
