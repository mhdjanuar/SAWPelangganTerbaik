...
import net.sf.jasperreports.view.JasperViewer;
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        // Set ke model
        PelangganModel pelanggan = new PelangganModel();
        pelanggan.setId(parseInt(this.selectedId)); // ID Karyawan yang akan diupdate
        pelanggan.setName(nama);
        pelanggan.setAlamat(alamat);

        // Panggil fungsi update di DAO
        int result = pelangganDao.update(pelanggan);
        if (result > 0) {
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        if (konfirmasi == JOptionPane.YES_OPTION) {
            ...
            int success = pelangganDao.deletePelanggan(parseInt(this.selectedId));
            if (success > 0) {
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try {
            String templateName = "LaporanKonsumenDIY.jrxml";
